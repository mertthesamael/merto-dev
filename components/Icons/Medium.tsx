export const MediumIcon = ({className}:{className?:string}) => {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={54} height={54} className={'rounded-lg min-w-[54px] min-h-[54px]'} viewBox="0 0 24 24">
            <g>
                <path className="fill-none dark:fill-white" fill="none" d="M0 0h24v24H0z" />
