...
export const Eth = () => {
    ...
    return(
	 ...
	 width="32px" height="32px" viewBox="0 0 226.777 226.777" enableBackground="new 0 0 226.777 226.777"
	>
    <path className="dark:fill-white fill-black" d="M113.313,0C50.732,0,0,50.732,0,113.313s50.732,113.313,113.313,113.313s113.313-50.732,113.313-113.313
